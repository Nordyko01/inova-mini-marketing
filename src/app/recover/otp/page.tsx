...
export default function Otp() {
    return (
        ...
        <div className=" w-[569px] h-[769.57px] top-[179.22px] left-[498px] rounded-xl py-11 px-[34px] gap-[10px] bg-white flex flex-col items-center justify-between">
            ...
            <h1 className="text-2xl font-bold">Verificar número de telefone</h1>
            <span className="text-[#8B8D97] w-80 text-center">Um texto com uma Palavra-Passe Única (OTP) foi enviado para o seu número de telemóvel: 930126035</span>
            ...
            <Button variant="outline" onClick={()=>window.location.href="/recover/reactepassword"} className="w-[501px] h-[52px] border-[1px] rounded-2xl text-white bg-[#A44035] hover:text-white hover:bg-[#A44035]">Pronto</Button>
